...
var addReferencesToPost = exports.addReferencesToPost = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(post) {
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return Tools.series(referencedPosts, function () {
              var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(ref, refKey) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            ...
            _context5.next = 7;
            return Tools.series(referencedPosts, function () {
              var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(ref, refKey) {
...
var rerenderReferringPosts = exports.rerenderReferringPosts = function () {
  var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(_ref10) {
        ...
        switch (_context7.prev = _context7.next) {
          ...
          case 3:
            ...
            return Tools.series(referringPosts, function () {
              var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(ref) {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _context9.next = 3;
            return Tools.series(referencedPosts, function () {
              var _ref16 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(ref) {
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            _context11.next = 3;
            return Tools.series(referringPosts, function () {
              var _ref19 = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(ref) {
...
function replaceRelatedPostLinks(_ref13) {
  var text = _ref13.text;
  var sourceBoardName = _ref13.sourceBoardName;
  var targetBoardName = _ref13.targetBoardName;
  var postBoardName = _ref13.postBoardName;
