...
exports.pushPostToArchive = exports.updateMovedThreadRelatedPosts = exports.rerenderMovedThreadRelatedPosts = exports.copyPosts = exports.rebuildSearchIndex = exports.rerenderPosts = exports.deletePost = exports.editPost = exports.removePost = exports.rerenderPost = exports.createPost = exports.getPostKeys = exports.getPosts = exports.getPost = undefined;
...
var getPost = exports.getPost = function () {
  var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(boardName, postNumber, options) {
...
var getPosts = exports.getPosts = function () {
  var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(boardName, postNumbers, options) {
        ...
        switch (_context5.prev = _context5.next) {
          ...
          case 20:
            ...
            return Tools.series(uniqueThreadNumbers, function () {
              var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(threadNumber) {
          ...
          case 23:
            ...
            return Tools.series(posts, function () {
              var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(post, index) {
...
var editPost = exports.editPost = function () {
  var _ref15 = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(req, fields) {
...
var deletePost = exports.deletePost = function () {
  var _ref16 = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(req, _ref17) {
    var boardName = _ref17.boardName;
        ...
        switch (_context12.prev = _context12.next) {
          ...
          case 22:
            ...
            return Tools.series(['json', 'html'], function () {
              var _ref18 = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(suffix) {
...
var forEachPost = function () {
  var _ref19 = _asyncToGenerator(regeneratorRuntime.mark(function _callee15(targets, action) {
    var postKeys;
        ...
        switch (_context15.prev = _context15.next) {
          ...
          case 6:
            ...
            return Tools.series(targets, function () {
              var _ref20 = _asyncToGenerator(regeneratorRuntime.mark(function _callee14(postNumbers, boardName) {
                var set;
                    ...
                    switch (_context14.prev = _context14.next) {
                      ...
                      case 5:
                        ...
                        return Tools.series(postNumbers, function () {
                          var _ref21 = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(postNumber) {
...
var rerenderPosts = exports.rerenderPosts = function () {
  var _ref22 = _asyncToGenerator(regeneratorRuntime.mark(function _callee17(targets) {
        ...
        switch (_context17.prev = _context17.next) {
          case 0:
            ...
            return forEachPost(targets, function () {
              var _ref23 = _asyncToGenerator(regeneratorRuntime.mark(function _callee16(boardName, postNumber) {
...
var rebuildPostSearchIndex = function () {
  var _ref24 = _asyncToGenerator(regeneratorRuntime.mark(function _callee18(boardName, postNumber) {
    var key, post;
...
var rebuildSearchIndex = exports.rebuildSearchIndex = function () {
  var _ref25 = _asyncToGenerator(regeneratorRuntime.mark(function _callee20(targets) {
      ...
      while (1) {
        switch (_context20.prev = _context20.next) {
          case 0:
            _context20.next = 2;
            return forEachPost(targets || {}, function () {
              var _ref26 = _asyncToGenerator(regeneratorRuntime.mark(function _callee19(boardName, postNumber) {
...
var copyPosts = exports.copyPosts = function () {
  var _ref27 = _asyncToGenerator(regeneratorRuntime.mark(function _callee23(_ref28) {
    var sourceBoardName = _ref28.sourceBoardName;
    var postNumbers = _ref28.postNumbers;
    var targetBoardName = _ref28.targetBoardName;
    var initialPostNumber = _ref28.initialPostNumber;
      ...
      while (1) {
        switch (_context23.prev = _context23.next) {
          ...
          case 15:
            ...
            _context23.next = 19;
            return Tools.series(posts, function () {
              var _ref29 = _asyncToGenerator(regeneratorRuntime.mark(function _callee22(post) {
                    ...
                    switch (_context22.prev = _context22.next) {
                      ...
                      case 19:
                        ...
                        return Tools.series(fileInfos, function () {
                          var _ref30 = _asyncToGenerator(regeneratorRuntime.mark(function _callee21(fileInfo) {
...
var rerenderMovedThreadRelatedPosts = exports.rerenderMovedThreadRelatedPosts = function () {
  var _ref31 = _asyncToGenerator(regeneratorRuntime.mark(function _callee25(_ref32) {
    var posts = _ref32.posts;
    var sourceBoardName = _ref32.sourceBoardName;
    var targetBoardName = _ref32.targetBoardName;
    var postNumberMap = _ref32.postNumberMap;
      ...
      while (1) {
        switch (_context25.prev = _context25.next) {
          case 0:
            _context25.next = 2;
            return Tools.series(posts, function () {
              var _ref33 = _asyncToGenerator(regeneratorRuntime.mark(function _callee24(post) {
                var _post, referencedPosts, text, source;
                ...
                return regeneratorRuntime.wrap(function _callee24$(_context24) {
                  while (1) {
                    switch (_context24.prev = _context24.next) {
                      ...
                      case 21:
                        _context24.next = 23;
                        return Search.updatePostIndex(post.boardName, post.number, function (body) {
                          body.plainText = post.plainText;
                          return body;
                        });
...
var updateMovedThreadRelatedPosts = exports.updateMovedThreadRelatedPosts = function () {
  var _ref34 = _asyncToGenerator(regeneratorRuntime.mark(function _callee27(_ref35) {
    var posts = _ref35.posts;
    var sourceBoardName = _ref35.sourceBoardName;
    var targetBoardName = _ref35.targetBoardName;
    var sourceThreadNumber = _ref35.sourceThreadNumber;
    var targetThreadNumber = _ref35.targetThreadNumber;
    var postNumberMap = _ref35.postNumberMap;
      ...
      while (1) {
        switch (_context27.prev = _context27.next) {
          case 0:
            _context27.next = 2;
            return Tools.series(posts, function () {
              var _ref36 = _asyncToGenerator(regeneratorRuntime.mark(function _callee26(post) {
                var _post2, referencedPosts, referringPosts, source, target;
                ...
                return regeneratorRuntime.wrap(function _callee26$(_context26) {
                  while (1) {
                    switch (_context26.prev = _context26.next) {
                      ...
                      case 5:
                        _post2 = post;
                        referencedPosts = _post2.referencedPosts;
                        referringPosts = _post2.referringPosts;
                        source = {
                          boardName: sourceBoardName,
                      ...
                      case 14:
                        _context26.next = 16;
                        return PostReferencesModel.removeReferringPosts(post.boardName, post.number, { archived: post.archived });
  ...
  return function updateMovedThreadRelatedPosts(_x53) {
    return _ref34.apply(this, arguments);
  };
}();

var pushPostToArchive = exports.pushPostToArchive = function () {
  var _ref37 = _asyncToGenerator(regeneratorRuntime.mark(function _callee28(boardName, postNumber) {
      ...
      while (1) {
        switch (_context28.prev = _context28.next) {
          case 0:
            ...
            return _context28.abrupt('return', Promise.reject(new Error(Tools.translate('Invalid board'))));
  ...
  return function pushPostToArchive(_x55, _x56) {
