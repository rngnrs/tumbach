        ...
        switch (_context7.prev = _context7.next) {
          ...
          case 2:
            ...
            return Tools.series(_underscore2.default.range(pageCount), function () {
              var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(pageNumber) {
...
router.paths = function () {
  var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(description) {
    var arrays;
        ...
        switch (_context9.prev = _context9.next) {
          ...
          case 2:
            ...
            return Tools.series(_board2.default.boardNames(), function () {
              var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(boardName) {
...
router.renderThread = function () {
  var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(key, data) {
    var _this2 = this;
                  ...
                  switch (_context11.prev = _context11.next) {
                    ...
                    case 22:
                      ...
                      return Tools.series(postsToRerender, function () {
                        var _ref13 = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(post, postNumber) {
                          var renderedPost;
...
router.renderPages = function () {
  var _ref14 = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(boardName, threadNumber) {
...
router.renderCatalog = function () {
  var _ref15 = _asyncToGenerator(regeneratorRuntime.mark(function _callee16(boardName) {
    var board;
        ...
        switch (_context16.prev = _context16.next) {
          ...
          case 3:
            ...
            return Tools.series(['date', 'recent', 'bumps'], function () {
              var _ref16 = _asyncToGenerator(regeneratorRuntime.mark(function _callee15(sortMode) {
                var catalog, suffix;
                    ...
                    switch (_context15.prev = _context15.next) {
                      ...
                      case 2:
                        ...
                        return Tools.series(catalog.threads, function () {
                          var _ref17 = _asyncToGenerator(regeneratorRuntime.mark(function _callee14(thread) {
        ...
        switch (_context18.prev = _context18.next) {
          ...
          case 16:
            ...
            posts.forEach(function (post) {
              ...
              var t = post.name && post.name.indexOf('span') === -1 ? post.name.indexOf('#') : -1;
              if (t > 0) {
...
router.render = function () {
  var _ref20 = _asyncToGenerator(regeneratorRuntime.mark(function _callee19(path) {
    var match;
...
function installThreadHandler(type) {
  router.get('/:boardName/res/:threadNumber.' + type, function () {
    var _ref21 = _asyncToGenerator(regeneratorRuntime.mark(function _callee20(req, res, next) {
