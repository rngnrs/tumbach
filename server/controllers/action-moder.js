...
router.post('/action/setThreadClosed', function () {
  var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(req, res, next) {
...
router.post('/action/setThreadUnbumpable', function () {
  var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(req, res, next) {
