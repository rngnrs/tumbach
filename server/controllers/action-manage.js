...
router.post('/action/registerUser', function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(req, res, next) {
    var _ref2, fields, password, _getRegisteredUserDat, levels, ips, hashpass;
...
router.post('/action/updateRegisteredUser', function () {
  var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(req, res, next) {
    var _ref4, fields, hashpass, _getRegisteredUserDat2, levels, ips;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            hashpass = _ref6.fields.hashpass;
...
router.post('/action/superuserAddFile', function () {
  var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(req, res, next) {
    var _ref8, _ref8$fields, dir, fileName, isDir, files;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            dir = _ref8$fields.dir;
            fileName = _ref8$fields.fileName;
            isDir = _ref8$fields.isDir;
            files = _ref8.files;
...
router.post('/action/superuserEditFile', function () {
  var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(req, res, next) {
    var _ref10, _ref10$fields, fileName, content;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 5:
            ...
            fileName = _ref10$fields.fileName;
            content = _ref10$fields.content;
...
router.post('/action/superuserRenameFile', function () {
  var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(req, res, next) {
    var _ref12, _ref12$fields, oldFileName, fileName;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 5:
            ...
            oldFileName = _ref12$fields.oldFileName;
            fileName = _ref12$fields.fileName;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 5:
            ...
            fileName = _ref14.fields.fileName;
...
router.post('/action/superuserRerender', function () {
  var _ref15 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(req, res, next) {
    var _ref16, _ref16$fields, _targets, archive;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 5:
            ...
            _ref16$fields = _ref16.fields;
            _targets = _ref16$fields.targets;
            archive = _ref16$fields.archive;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 5:
            ...
            _targets2 = _ref18.fields.targets;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 5:
            ...
            _targets3 = _ref20.fields.targets;
...
router.post('/action/superuserReload', function () {
  var _ref21 = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(req, res, next) {
    var _ref22, _ref22$fields, boards, templates;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 5:
            ...
            _ref22$fields = _ref22.fields;
            boards = _ref22$fields.boards;
            templates = _ref22$fields.templates;
